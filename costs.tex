\section{Performance influence}
	...
	\begin{itemize}
		...
		\item Running the metric \texttt{Undirected\allowbreak Clustering\allowbreak
			...
			profiling enabled \todoInline{Revise numbers based on new recommender strategy}
		\item Running the metric \texttt{Degree\allowbreak DistributionR} takes $\sim 3300$
			msec without profiling and $\sim 7500$ msec with profiling enabled  \todoInline{Revise
			numbers based on recommender strategy}
	\end{itemize}
	
	\todoInline{Comparison for profiler}